...
export interface ApiLoanLoan extends Schema.CollectionType {
  ...
  attributes: {
    loan_date: Attribute.Date;
    return_deadline: Attribute.Date;
    return_date: Attribute.Date;
    condition: Attribute.String;
    total_payment: Attribute.Integer;
    member: Attribute.Relation<
      'api::loan.loan',
      'manyToOne',
      'api::member.member'
    >;
    movie_tape: Attribute.Relation<
      'api::loan.loan',
      'manyToOne',
      'api::movie-tape.movie-tape'
    >;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiMovieTapeMovieTape extends Schema.CollectionType {
  ...
  attributes: {
    ...
    late_fine: Attribute.Integer;
    damage_costs: Attribute.Integer;
    loans: Attribute.Relation<
      'api::movie-tape.movie-tape',
      'oneToMany',
      'api::loan.loan'
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::movie-tape.movie-tape': ApiMovieTapeMovieTape;
    }
  }
}
